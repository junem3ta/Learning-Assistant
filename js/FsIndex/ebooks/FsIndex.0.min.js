/* 
        ...
        "unassingend":{
            ...
            @24hr intervals, check uploads.unassigned. For a _single_ hashfromfilename obj:
                ...
                Iterate on ModeratorsObj and return moderatorID obj with least assignment count. Set id to the propname of this moderatorID.
                  ...
                  Update contributors.contributorID.contributions.hashfromfilename.status to allocatedToModerator.
            ...
            "hashfromfilename": {
                ...
                "author":contributor.emailaddr,email
    ...
    /*  
        ...
        Upload new eBook(s) to Create user account (?):qn-circle.
            > All content on eReadCU is open-source. The standard user account is a super user account with unlimited access to all 
            revision content. User accounts are only required for when you're contributing to the eRead Community, mainly for purposes 
                ...
                Approval Interface
                    :Use assignments obj on UI to render notifications.
                        :Loop through assignments
                            :assignments.hashfromfilename.notifiedOnUI==false ? Add _NEW_ marker to notification : Add _REVIEW_ option to notification.
        ...
        /* Create contributors obj | UI/B.E Notification processes *//*e   
    *//*
        ...
        contributorID: {
            ...
            "contributions": {
                "hashfromfilename": {
                    ...
                    "course": course,
                    "uploaddate": timestamp,
                    "status": "unassigned | allocatedToModerator | approved | rejected"
                }
            }
        }
    }
